...
export const googleAuthenticate = (state: any, code: any) => async (dispatch: any) => {
...
export const signup =
  (username: any, email: any, password: any, re_password: any) =>
  async (dispatch: any) => {
    const config = {
      headers: {
        "Content-Type": "application/json",
...
export const verify = (uid: any, token: any) => async (dispatch: any) => {
  const config = {
    headers: {
      "Content-Type": "application/json",
    },
...
export const reset_password = (email: any) => async (dispatch: any) => {
  const config = {
    headers: {
      "Content-Type": "application/json",
    },
